...
public class Juego {
	...
	public static void jugar(Jugador jugador_seleccionado) {
		...
		for (int i=0;i<3;i++) {
			...
			if(pregunta_Random.getRespuesta1().equalsIgnoreCase(respuesta)) {
				if (pregunta_Random.isRespuesta1_correcta()) {
					System.out.println("Has acertado");
					int puntuacion = jugador_seleccionado.getPuntuacion() +5;
					jugador_seleccionado.setPuntuacion(puntuacion);
			...
			}else if(pregunta_Random.getRespuesta2().equalsIgnoreCase(respuesta)) {
				if (pregunta_Random.isRespuesta2_correcta()) {
					System.out.println("Has acertado");
					int puntuacion = jugador_seleccionado.getPuntuacion() +5;
					jugador_seleccionado.setPuntuacion(puntuacion);
				}else {
			...
			}else if(pregunta_Random.getRespuesta3().equalsIgnoreCase(respuesta)) {
				if (pregunta_Random.isRespuesta3_correcta()) {
					System.out.println("Has acertado");
					int puntuacion = jugador_seleccionado.getPuntuacion() +5;
					jugador_seleccionado.setPuntuacion(puntuacion);
				}
				...
				System.out.println("No has seleccionado ninguna de las 3 opciones");
			}

		}
		System.out.println("Puntuacion Total:"+jugador_seleccionado.getPuntuacion());
