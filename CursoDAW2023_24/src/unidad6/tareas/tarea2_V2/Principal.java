	...
	public static void main(String[] args) {
		...
		do {
			...
			case 3: //BUSCAR RECETA
				...
				break;
			case 4:  //MOSTRAR RECETAS POR DIFICULTAD //CORREGIR, CUANDO PONES MAL DE PRIMERAS LA DIFICULTAD, NO SE HACE BIEN
				...
				break;
			case 5: // CREAR COCINERO
				
				Cocinero.crearCocinero();
				
				break;
			case 6: // MOSTRAR COCINEROS
				System.out.println("holahgola1");
				Cocinero.mostrarCocineros();
